...
<div class="panel admin-panel">
  <div class="panel-head" id="add"><strong><span class="icon-pencil-square-o"></span>个人信息修改</strong></div>
  <div class="body-content">
    <form action="<%=path %>/selfmodify.action" method="post" name="userLogin" class="form-x">
