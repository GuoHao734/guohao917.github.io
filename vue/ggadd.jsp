...
<div class="panel admin-panel">
  ...
  <div class="body-content">
    <form action="<%=path %>/ggadd.action" method="post" name="userLogin" class="form-x">
      <div class="form-group">
        <div class="label">
          <label> 标题：</label>
        </div>
        <div class="field">
          <input type="text" class="input w50" value="" name="titles" id="titles" data-validate="required:请输入标题" />
          <div class="tips"></div>
        </div>
      </div>
       <div class="form-group">
